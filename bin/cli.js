...
yargsCmd.usage('Botium Connector NUANCE CLI\n\nUsage: $0 [options]') // eslint-disable-line
  ...
  .command({
    command: 'import',
    describe: 'Downloading Convos and Utterances from NUANCE App to Botium',
    builder: (yargs) => {
  ...
  .command({
    command: 'export',
    describe: 'Uploading Utterances from Botium to NUANCE app',
    builder: (yargs) => {
